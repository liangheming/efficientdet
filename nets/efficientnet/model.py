...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        for block_args in self._blocks_args:
            ...
            if block_args.stride[0] == 2:
                self.out_channels.append(block_args.input_filters)
            ...
            last_output_channel = block_args.output_filters
        self.out_channels.append(last_output_channel)
